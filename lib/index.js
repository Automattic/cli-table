...
/**
 * Improve push so an object with multiple elements
 * can be used instead of requiring an array element for each row
 *
...
Table.prototype.push = function() {
  ...
  for (var i = 0; i < args.length; i++) {
    ...
    for (var j = 0; j < keys.length; j++) {
      var o = {};
      o[keys[j]] = arg[keys[j]];
      counter += Array.prototype.push.call(this, o);
    }
  }
  return counter;
}
